      ...
      <form wire:submit="authenticate" class="space-y-4 w-full self-center">
          <div class="flex flex-col md:flex-row justify-center lg:justify-start items-center gap-4 pb-4">
            ...
            <div class="-mt-2 md:-mt-1">
              <h1 class="font-extrabold text-center md:text-start text-3xl md:text-4xl">SIMANTAP</h1>
              <h2 class="font-light text-center md:text-start text-[10px] md:text-xs md:-mt-1">Sistem Informasi Manajemen dan <br class="md:hidden">Tenaga Pegawai</h2>
            </div>
          </div>
          {{ $this->form }}
