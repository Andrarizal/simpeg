<div class="w-full max-w-xl bg-white dark:bg-gray-900 rounded-3xl shadow-[0px_10px_30px_-10px_rgba(0,0,0,0.05)] dark:shadow-none border border-gray-200 dark:border-gray-800 overflow-hidden ring-1 ring-gray-950/5 dark:ring-white/10">
        ...
        <div class="divide-y divide-gray-100 dark:divide-gray-800">
            ...
            <div class="px-6 py-4 flex flex-col sm:flex-row sm:justify-between sm:items-center gap-2 hover:bg-gray-50/50 dark:hover:bg-gray-800/50 transition">
                <div class="flex items-center gap-3">
                    <div class="p-2 bg-gray-100 dark:bg-gray-800 rounded-xl text-gray-500 dark:text-gray-400">
            ...
            <div class="px-6 py-4 flex flex-col sm:flex-row sm:justify-between sm:items-center gap-2 hover:bg-gray-50/50 dark:hover:bg-gray-800/50 transition">
                ...
                <div class="text-gray-950 dark:text-white font-semibold text-right">
                    <h6 class="mb-0">{{ \Carbon\Carbon::parse($date)->locale('id')->isoFormat('D MMMM Y') }}</h6>
                    <p class="text-xs text-gray-700 dark:text-gray-200 font-light dark:font-thin -mt-1">{{ \Carbon\Carbon::parse($date)->locale('id')->isoFormat('HH:mm') }} WIB</p>
                </div>
            </div>
