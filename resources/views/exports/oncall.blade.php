...
<body>
    <div class="Section1">
        ...
        <h3 style="text-align:center; margin:0">Rekap Tugas On Call Periode {{ $month }}</h3>
        <br><br>
        ...
        <table>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td style="width: 14%">{{ \Carbon\Carbon::parse($p->oncall_date)->translatedFormat('l, d F Y') }}</td>
                    <td style="width: 18%">{{ $p->commander->name }}</td>
                    <td>{{ $p->command }}</td>
            ...
            <tfoot>
                <tr>
                    <td colspan="6" style="text-align: center; font-weight: bold">Total Jam Tugas</td>
