    ...
    <table class="table-data">
        <tr>
            ...
            <td width="33%">
                ...
                <span class="content">{{ ($record->start_date ? \Carbon\Carbon::parse($record->start_date)->translatedFormat('d F Y') . ($record->end_date ? ' - ' . \Carbon\Carbon::parse($record->end_date)->translatedFormat('d F Y') : '') : '') }}</span>
            </td>
            <td width="33%">
              <div>
